...
///class carthome extends Component {
    ...
    <a href='http://localhost:3000/add-item/_add'>
                                ...
                                <br></br>
<div style={{backgroundColor:"pink",width:"280px",marginLeft:40}} >
            ...
            <h1 className="text-center mt-3" style={{fontWeight:"bold"}}> Grooms  Wear</h1>
            ...
            <section className="py-4 container">
                <div className="row justify-content-center">
                    {groomdata.productData.map((item,index)=>{
