...
const CARD_PAYMENT_DETAILS_BASE_URL = "http://localhost:8080/api/v3/cardDetails";
...
class CardPaymentDetailsService {
    ...
    updatShippingDetails( cardDetails, cardPaymentID){
        return axios.put(CARD_PAYMENT_DETAILS_BASE_URL + '/' + cardPaymentID, cardDetails)
    }
