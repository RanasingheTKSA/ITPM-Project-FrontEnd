...
const SHIPPING_DETAILS_BASE_URL =
  "http://localhost:8080/api/v2/shippingDetails";
...
class ShippingDetailsService {
  ...
  updateShippingAddress(shippingDetails, shippingID) {
    return axios.put(
      SHIPPING_DETAILS_BASE_URL + "/" + shippingID,
      shippingDetails
    );
  }

  deleteShippingDetails(shippingID) {
    return axios.delete(SHIPPING_DETAILS_BASE_URL + "/" + shippingID);
  }
}
